...
config :materia_commerce,
  ecto_repos: [MateriaCommerce.Test.Repo]

# Configures the endpoint
config :materia_commerce, MateriaCommerceWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "xAeVCjjYbPDJQW5oou/zXYHs9KpzNG3XOO/zZuEFxKpTCAwc09sEm9REdzlGPqnE",
  render_errors: [view: MateriaCommerceWeb.ErrorView, accepts: ~w(html json)],
  pubsub: [name: MateriaCommerce.PubSub,
...
config :guardian, Guardian.DB,
  repo: MateriaCommerce.Test.Repo,  #<- mod your app repo
