defmodule MateriaCommerce.Products.Item do
  ...
  def create_changeset(item, attrs) do
    IO.inspect(attrs)
    item
    |> cast(attrs, [:name, :category1, :category2, :category3, :category4, :item_code, :model_number, :jan_code, :thumbnail, :image_url, :size1, :size2, :size3, :size4, :weight1, :weight2, :weight3, :weight4, :delivery_area, :manufacturer, :status, :color, :description, :start_datetime, :end_datetime, :tax_category, :lock_version])
    |> validate_required([:name, :item_code, :start_datetime, :end_datetime, :lock_version])
  end
