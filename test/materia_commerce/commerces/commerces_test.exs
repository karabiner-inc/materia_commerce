defmodule MateriaCommerce.CommercesTest do
  ...
  describe "contracts" do
    ...
    test "delete_future_contract_histories/2 delete status3" do
      ...
      assert result == 1
      assert !Enum.any?(contracts, fn(contract)-> contract.status == "ステータス3" end)
    end
  ...
  describe "contract_details" do
    ...
    @contract_valid_attrs %{billing_address: 42, buyer_id: 42, contract_no: "some contract_no", contracted_date: "2010-04-17 14:00:00.000000Z", delivery_address: 42, delivery_end_datetime: "2010-04-17 14:00:00.000000Z", delivery_start_datetime: "2010-04-17 14:00:00.000000Z", expiration_date: "2010-04-17 14:00:00.000000Z", seller_id: 42, sender_address: 42, settlement: "some settlement", shipping_fee: "120.5", status: "some status", tax_amount: "120.5", total_amount: "120.5", start_datetime: "2010-04-17 14:00:00.000000Z", end_datetime: "2010-04-17 14:00:00.000000Z"}
