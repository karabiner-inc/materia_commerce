defmodule MateriaCommerceWeb.ContractDetailControllerTest do
  ...
  @create_attrs %{
    ...
    datetime1: "2010-04-17 14:00:00.000000Z",
    datetime2: "2010-04-17 14:00:00.000000Z",
    datetime3: "2010-04-17 14:00:00.000000Z",
    datetime4: "2010-04-17 14:00:00.000000Z",
    inserted_id: 1,
    delivery_id: 1
  }
  @update_attrs %{
  ...
  describe "update contract_detail" do
    ...
    test "renders contract_detail when data is valid", %{
      conn: conn,
      contract_detail: %ContractDetail{id: id} = contract_detail
    } do
